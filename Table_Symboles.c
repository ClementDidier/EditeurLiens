...
void afficher_table_symboles( FILE *f )
{
	unsigned int tmp;
	unsigned int symtab_off = 0, strtab_off = 0, symtab_size = 0; 
	int strtab_index, lus;
	Elf32_Ehdr h;
	Elf32_Sym symb;
